...
subparsersUser = parserUser.add_subparsers(help="Description", required=True)
...
subparsersOrgAddReq.add_argument('-t', help="Access token file. default ak.token", type=str, metavar="Filename", default="ak.token")
...
subparsersOrgAddOpt.add_argument('--aemail', help="Email Alias. max 20", type=str, nargs="*", metavar="aEmail")
